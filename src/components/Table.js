...
import { calculateFixedWidth, enhanceColumns, scheduleLayout } from './mixins'
import { getScrollBarWidth } from './utils'
import TableHeader from './TableHeader'
import TableBody from './TableBody'
import TableFooter from './TableFooter'

import type { DefaultTableProps, TableProps, TableState } from './Types'
...
export default class Table extends Component{
  ...
  render() {
    ...
    const rootClassName = this.className(
      'mff-table',
      {
        'mff-table--enable-row-hover': !fixedLeftColumns.length && !fixedRightColumns.length,
        'mff-table--fit': fit,
        'mff-table--striped': stripe,
        'mff-table--border': border
      }
    );
    ...
    return (
      <div
        ...
        <div
          ref="headerWrapper"
          className="mff-table__header-wrapper">
          <TableHeader
            ref="header"
            isScrollY={scrollY}
        ...
        </div>
        {
          !!fixedLeftColumns.length && (
            <div
              ...
              <div className="mff-table__fixed-header-wrapper" ref="fixedHeaderWrapper">
                <TableHeader
                  fixed="left"
                  border="border"
                  columns={_columns}
              ...
              <div
                ...
                {(!data || data.length === 0) &&
                <div style={{ width: bodyWidth }} className="mff-table__empty-block">
                  <span className="mff-table__empty-text">{ emptyText }</span>
                </div>
                }
              </div>
            </div>)
        ...
        <div
          ...
          <div
            className="mff-table__fixed-header-wrapper"
        ...
        <div
          ...
          className="mff-table__column-resize-proxy"
          ref="resizeProxy">
        </div>

        <div className="mff-table__body-scroller">
          <div></div>
        </div>
      </div>
    )
